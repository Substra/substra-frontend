...
export default props => (
    ...
    >
        <defs>
            <style>{'.cls-1{fill:#f2f2f2;}.cls-2{fill:url(#Dégradé_sans_nom_2);}.cls-3{fill:url(#Dégradé_sans_nom_2-2);}.cls-4{fill:url(#Dégradé_sans_nom_26);}.cls-5{fill:url(#Dégradé_sans_nom_5);}.cls-6{fill:url(#Dégradé_sans_nom_27);}.cls-7{fill:#1e1e1e;}'}</style>
            <linearGradient
            ...
            >
                <stop offset="0" stopColor="#16addb" />
                <stop offset="0.13" stopColor="#19a9dc" />
                <stop offset="0.25" stopColor="#229dde" />
                <stop offset="0.38" stopColor="#3189e2" />
                <stop offset="0.5" stopColor="#476de8" />
                <stop offset="0.63" stopColor="#6249ef" />
                <stop offset="0.71" stopColor="#772df4" />
                <stop offset="0.96" stopColor="#ed1e79" />
            </linearGradient>
        </defs>
        <title>OwkestraLogo</title>
        <path
            className="cls-1"
