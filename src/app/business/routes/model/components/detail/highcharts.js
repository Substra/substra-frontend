...
if (ReactHighcharts.Highcharts.Axis) {
    ReactHighcharts.Highcharts.wrap(ReactHighcharts.Highcharts.Axis.prototype, 'getPlotLinePath', function getPlotLinePathWrapper(proceed, lineWidth) {
    ...
    ReactHighcharts.Highcharts.wrap(ReactHighcharts.Highcharts.Axis.prototype, 'getLinePath', function getLinePathWrapper(p, lineWidth) {
